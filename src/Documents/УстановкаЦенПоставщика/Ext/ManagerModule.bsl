...
Функция ЗаполнитьТаблицуТоваров(Знач таблицаТовары, Знач табличныйДокументПрайсЛист) Экспорт
    прайсДист = Неопределено;
    Попытка
        прайсДист = Обработки.ЗагрузкаПрайсЛиста.ПолучитьТаблицуЗначенийИзТабличногоДокумента(табличныйДокументПрайсЛист);
    Исключение
    ...
    Пока выборка.Следующий() Цикл
        новСтрокаТовары = таблицаТовары.Добавить();
