...
Процедура ОбработкаОповещения(имяСобытия, параметрыСобытия, ___)
    ...
    создатьДокументУстановкиЦен(формаЗагрузчика.ПрайсЛист);
КонецПроцедуры
...
// Параметры:
//  формаЗагрузчика - Форма
&НаКлиенте
Процедура создатьДокументУстановкиЦен(Знач формаЗагрузчика)
    документУстановкиЦенСсылка = создатьДокументНаСервере(
            формаЗагрузчика.ДатаПрайсЛиста, формаЗагрузчика.Поставщик, формаЗагрузчика.ПрайсЛист);
