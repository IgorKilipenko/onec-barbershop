...
// Параметры:
//	_ - Булево - Отказ. Признак отказа от записи документа. Не используется в текущей реализации
//	__ - РежимЗаписиДокумента - Режим записи документа. Не используется в текущей реализации
//	___ - РежимПроведенияДокумента - Позволяет определить, выполняется оперативное проведение или нет.
