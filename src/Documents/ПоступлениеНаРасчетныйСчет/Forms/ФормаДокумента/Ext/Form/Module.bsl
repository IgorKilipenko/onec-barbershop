...
Функция получитьСкрываемыеПоляПриИзмененииВидаОперации()
    ...
    изменяемыеПоля = _УправляемыеПоля[Элементы.ВидОперации];
    ...
    Если ЗначениеЗаполнено(Объект.ВидОперации) Тогда
        ...
        Если НЕ этоВзносНаличными() Тогда
        ...
        Если НЕ этоОплатаПоБанковскимКартам() Тогда
...
Функция получитьСкрываемыеПоляПриИзмененииПлательщика()
    скрываемыеПоля = Новый Структура;
    изменяемыеПоля = _УправляемыеПоля[Элементы.Плательщик];
...
Процедура инициализация()
    ...
    _УправляемыеПоля = получитьСтруктуруУправляемыхПолей();
КонецПроцедуры
...
&НаКлиенте
Функция получитьСтруктуруУправляемыхПолей()
    ...
    результат.Вставить(Элементы.ВидОперации, Новый ФиксированныйМассив(изменяемыеПоля));

    // Для Плательщик
    изменяемыеПоля = Новый Массив;
    изменяемыеПоля.Добавить(Элементы.ДоговорКонтрагента);

    результат.Вставить(Элементы.Плательщик, Новый ФиксированныйМассив(изменяемыеПоля));
