...
Функция СоздатьСтруктуруАналитикиПроводки(Знач описаниеДебетаСчета = Неопределено,
    ...
    // Проверка аргументов
    контекстДиагностики = "БухгалтерскийУчет.СоздатьСтруктуруАналитикиПроводки";
...
Функция этоДопустимоеОписаниеСчета(Знач описаниеСчета)
    ...
    результат = описаниеСчета <> Неопределено И (типОписания = Тип("Структура") ИЛИ типОписания = Тип("ФиксированнаяСтруктура"));
