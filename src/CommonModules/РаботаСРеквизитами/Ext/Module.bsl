...
//  псевдонимТаблицы - Строка - По умолчанию: "ПсевдонимЗаданнойТаблицы"
// Возвращаемое значение:
//  Строка
Функция СформироватьТекстЗапросаПолейПоРеквизитам(Знач структураПолей, псевдонимТаблицы = "ПсевдонимЗаданнойТаблицы") Экспорт
    текстЗапросаПолей = "";
