...
Функция получитьДанныеЧисловыхПоказателей(Знач датаНачала, Знач датаОкончания)
	...
	запрос.Текст =
		...
		|ПОМЕСТИТЬ ВТ_ДокументыРТУ
		|ИЗ
		|	Документ.РеализацияТоваровИУслуг КАК РеализацияТоваровИУслуг
		|ГДЕ
		|	РеализацияТоваровИУслуг.Ссылка В
		|			(ВЫБРАТЬ
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВТ_ЗаказыКлиентов.ЗаписьКлиента КАК ЗаписьКлиента,
		|	ВТ_ДокументыРТУ.ДокументРТУ КАК ДокументРТУ
		|ПОМЕСТИТЬ ВТ_ЗаказыКлиентов_ДокументыРТУ
		|ИЗ
		|	ВТ_ЗаказыКлиентов КАК ВТ_ЗаказыКлиентов
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ДокументыРТУ КАК ВТ_ДокументыРТУ
		|		ПО (ВТ_ДокументыРТУ.ДокументОснование = ВТ_ЗаказыКлиентов.ЗаписьКлиента)
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ДокументРТУ
		|;
		...
		|ИЗ
		|	ВТ_Продажи КАК ВТ_Продажи
		|		ПРАВОЕ СОЕДИНЕНИЕ ВТ_ЗаказыКлиентов_ДокументыРТУ КАК ВТ_ЗаказыКлиентов
		|		ПО (ВТ_ЗаказыКлиентов.ДокументРТУ = ВТ_Продажи.Регистратор)
		|";
